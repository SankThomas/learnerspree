...
```html
<blockquote cite="http://learner.com">
  You can easily learn how to code using Learner. Did you know?
</blockquote>
```
...
<body>
  <article>
    <h1>Welcome to self-taught learning with Learner</h1>
    <p>
      Learn programming, transcription and even cybersecurity with our extensive
      documentation
    </p>
    <button>Show me how</button>
    <img src="https://learner.com/logo.png" alt="Learner logo" />
  </article>
</body>
```
...
```html
<form action="https://api.learner.com/index.php">
  <!-- Rest of code -->
...
```html
<head>
  <title>Learner online course modules</title>
</head>
```
