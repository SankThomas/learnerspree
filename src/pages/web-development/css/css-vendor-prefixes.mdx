...
In order to bridge the gap between how browsers implement CSS, vender prefixes were introduced. For example, if I wanted to add a transition normally, I would do this:
