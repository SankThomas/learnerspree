...
<form className="grid grid-cols-1 gap-4 sm:grid-cols-2">
    <article className="flex flex-col gap-2 border border-slate-100 dark:border-slate-800 p-4 rounded-lg">
        <label htmlFor="checkbox1" className="block">Default checkbox</label>
        <input type="checkbox" id="checkbox1" />
    </article>
    
    <article className="flex flex-col gap-2 border border-slate-100 dark:border-slate-800 p-4 rounded-lg">
        <label htmlFor="checkbox2" className="block">Checkbox with `accent-color` applied</label>
        <input type="checkbox" id="checkbox2" className="accent-rose-400" />
    </article>
    
    <article className="flex flex-col gap-2 border border-slate-100 dark:border-slate-800 p-4 rounded-lg">
        <label htmlFor="range" className="block">Range slider with `accent-color` applied</label>
