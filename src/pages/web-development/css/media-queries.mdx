...
Let's put our knowledge to the test. If you wanted to create a cool-looking and responsive profile card like the one below, how would you do it?
...
In your workspace, create a new file called `index.html`. In this file, add in the following code:
...
<!-- Other code -->
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
<link href="index.css" rel="stylesheet" /> <!-- Added line -->
<title>Profile Card</title>
<!-- Rest of your code -->
```
