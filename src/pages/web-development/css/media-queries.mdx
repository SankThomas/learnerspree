...
<Callout type="info">
### Caution!
    When adding media queries, make sure that the CSS selectors you use correspond to how you styled them before the media query. Otherwise, you might find the styles in your media query not applying at all, or you might run into bugs in your code which are very hard to debug because vanilla CSS doesn't give you any kind of error handling. For example, don't do this:
