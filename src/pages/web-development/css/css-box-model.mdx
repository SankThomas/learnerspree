...
And it works with all border styles: solid, dotted, dashed and double.
...
The total height for the section will not be `288px`: i.e `200px + 20px + 20px + 16px + 16px + 8px + 8px`
