...
<button className="bg-[pink] hover:bg-[navy] text-black hover:text-white py-[8px] px-[32px]">Get Started</button>

The `hover` state can also be used to those nice little tooltips that pop up when you hover over elements and give you more information about them - or about a certain setting on a website.
