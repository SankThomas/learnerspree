...
You can also sadd multiple classes for in a single element. All you need to do is separate the different class names with a single space. For example:
...
<p id="aliceblue">
  And without a second thought, down went Alice after it.
</p>
```
...
<Callout type="warning">
  ...
  However, It is something to take note of in case you want to have different styles for particular elements. If that is the case, you can use class names, or you can use [pseudo classes](#pseudo-classes)
</Callout>
