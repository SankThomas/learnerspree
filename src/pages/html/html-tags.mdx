...
It can also be used together with the `picture` tag in order to add multiple images for different device widths. More on this on the module about [Working With Images](/html/working-with-images#the-picture-element)
...
More about tables is in the module [Working With Tables](/html/working-with-tables)
