...
| ---------------------------------------------------------------- | ---------------------------------------------------- |
| ![tsbsankara-homepage](src/assets/tsbsankara-homepage.png)       | [TsbSankara Homepage](https://tsbsankara.com)        |
| ![traversymedia-homepage](src/assets/traversymedia-homepage.png) | [Traversy Media Homepage](https://traversymedia.com) |
| ![github-homepage](src/assets/github-homepage.png)               | [GitHub Homepage](https://github.com)                |
...
<img src="https://eduketa.com/logo.png" alt="Image from the internet" />
```
...
<img src="./slow-network.png" alt="This is a local image" />

<!-- No active internet show the alt text -->
<img src="https://eduketa.com/logo.png" alt="Image from the internet" />

<!-- Path to image has changed -->
<img src="PATH_HAS_CHANGED.svg" alt="Image from the internet" />

<!-- Wrong path to image shows the alt text -->
<img src="https://eduketa.com/wrong-path.jpg" alt="Image from the internet" />

<!-- Wrong file extension shows the alt text -->
<img src="https://eduketa.com/no-image.jpeeg" alt="Image from the internet" />
```
...
```html
<img
  src="https://eduketa.com/logo.png"
  height="200px"
  width="300px"
...
```html
<img src="https://eduketa.com/animation.gif" alt="An animated image" />
```
...
They snippet above links the image to the Frontend Mentor homepage. The image below shows what to expect when running the code. Click on the image to test it out.
